...
import {
  ...
  useMemo,
  useState,
} from '~/libs/hooks/index.js';
import { type ServerErrorHandling, type ValueOf } from '~/libs/types/index.js';

import { Icon } from '../components.js';
import styles from './styles.module.scss';
import { FC } from 'react';
import { IconName, InputType } from '~/libs/enums/index.js';
...
const Input: FC<InputProps<FieldValues>> = ({
  control,
  errors,
  label = '',
  name,
